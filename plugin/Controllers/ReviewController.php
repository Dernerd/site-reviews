...
use Psource\SiteReviews\Commands\SubmitReview;
...
class ReviewController extends BaseController
{
	...
	public function postSubmitReview( array $request )
	{
		...
		if( $this->app->make( 'Psource\SiteReviews\Blacklist' )->isBlacklisted( $submitReview )) {
		...
		// Akismet validation
		if( $this->app->make( 'Psource\SiteReviews\Akismet' )->isSpam( $submitReview )) {
			$session->set( "{$validatedRequest['form_id']}-errors", [] );
